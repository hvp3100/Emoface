...
def main():
    ...
    path_to_affectnet = "/ps/project/EmotionalFacialAnimation/data/emoface/"
    path_to_processed_affectnet = "/is/cluster/work/rdanecek/data/emoface/"
    ...
    single_stage_deca_pass(face_model, conf, stage="test", prefix="affect_net_mturk", dm=dm, project_name_="EmofaceMTurkTests",
