...
from gdl_apps.interactive_deca_decoder import load_deca_and_data, test #, plot_results
...
def main():
    deca_models = {}
    deca_models[""] \
        = "/is/cluster/work/rdanecek/emoface/finetune/" \
          "2024_09_07_17-19-36_Exp_Affec_balanced_expr_para_early/"
    target_image_path = Path("/is/cluster/work/rdanecek/data/aff-wild2/processed/processed_2024_Jan_19_20-25-10")
    ...
    out_folder = '/is/cluster/work/rdanecek/emoface/optimize_emotion'
...
def probe_video():
    save_path = Path('/home/optimize_emotion/2024_03_19_16-11-5/000640_000/from_input')
